    ...
    <div class="grid md:grid-cols-3 gap-8 mt-8">
        ...
        @empty
            @php($fallback = [
                ...
                ['title' => 'تجهيز المناسبات والبوفيهات', 'desc' => 'تنظيم وتقديم بوفيهات متنوعة مع لمسات فنية مميزة.', 'img' => 'images/جوهرة الكويت لتاجير طاولات وكراسي/جوهرة الكويت لتأجير طاولات وكراسي.webp'],
