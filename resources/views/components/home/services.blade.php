    ...
    <div class="container mx-auto px-4 py-0">
        ...
        <div class="text-center mb-16">
            ...
            <div class="flex items-center justify-center gap-3 mt-6">
                <div class="w-12 h-1 bg-linear-to-r from-transparent to-primary rounded-full"></div>
                <div class="w-3 h-3 bg-primary rounded-full"></div>
                <div class="w-12 h-1 bg-linear-to-l from-transparent to-primary rounded-full"></div>
            </div>
        </div>
        ...
        <div class="mt-16 text-center">
            <div class="inline-flex flex-col sm:flex-row items-center gap-4 p-8 rounded-2xl bg-linear-to-br from-primary/10 via-green-50 to-primary/5 border border-primary/20">
