...
/4.jpeg',
    ...
    ['title' => 'خدمة ضيافة نسائي', 'images' => [
        'images/جوهرة الكويت خدمة ضيافة نسائي/1.jpeg',
        'images/جوهرة الكويت خدمة ضيافة نسائي/2.jpeg',
        'images/جوهرة الكويت خدمة ضيافة نسائي/3.jpeg',
        'images/جوهرة الكويت خدمة ضيافة نسائي/4.jpeg',
    ]],
    ['title' => 'خدمة تفتيش التلفونات', 'images' => [
            ...
            @foreach($groups as $idx => $g)
                <div class="tab-panel grid md:grid-cols-4 gap-4" data-panel="{{ $idx }}" style="{{ $idx === 0 ? '' : 'display:none' }}">
                    @foreach(array_slice($g['images'], 0, 4) as $img)
                        <img src="{{ asset($img) }}" class="w-full object-cover rounded-xl" style="aspect-ratio:4/3;"
