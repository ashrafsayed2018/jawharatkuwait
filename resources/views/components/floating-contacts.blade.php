...
<div class="fixed bottom-4 right-4 z-50 flex flex-col gap-3">
    <a href="https://wa.me/{{ Str::startsWith($whatsapp, '965') ? $whatsapp : '965'.$whatsapp }}" target="_blank" rel="noopener" class="w-12 h-12 rounded-full bg-green-500 shadow-lg grid place-items-center text-white">
