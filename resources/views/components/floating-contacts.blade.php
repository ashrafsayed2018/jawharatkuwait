...
<div class="fixed bottom-4 left-4 z-50 flex flex-col gap-3">
    @if($instagram)
    <a href="{{ $instagram }}" target="_blank" rel="noopener" class="w-12 h-12 rounded-full bg-purple-600 shadow-lg grid place-items-center text-white hover:scale-110 transition-transform duration-300">
