...
<section class="relative pt-24 pb-16 bg-linear-to-br from-gray-50 via-white to-primary/5">
        ...
        <div class="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div class="relative group">
             ...
             loading="lazy"
                        ...
                        <!-- Decorative Corner -->
                        <div class="absolute top-0 right-0 w-32 h-32 bg-linear-to-br from-primary/30 to-transparent rounded-bl-full"></div>
                        <div class="absolute bottom-0 left-0 w-32 h-32 bg-linear-to-tr from-primary/30 to-transparent rounded-tr-full"></div>
                    </div>

                    <!-- Floating Badge -->
                    <div class="absolute -top-4 -right-4 bg-linear-to-r from-primary to-green-600 text-white px-6 py-3 rounded-2xl shadow-xl transform rotate-3 hover:rotate-0 transition-transform duration-300">
            ...
            <div class="space-y-8">
                ...
                <div>
                    ...
                    <h1 class="text-4xl md:text-5xl font-bold mb-4 bg-linear-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent">
                        {{ $service->title }}
                    </h1>
                </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            @foreach($service->galleries as $gallery)
             ...
             loading="lazy">
                    ...
                    <!-- Overlay -->
                    <div class="absolute inset-0 bg-linear-to-t from-black/60 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            @forelse($relatedPosts as $post)
             ...
             loading="lazy"
                                 alt="{{ $post->title }}">
                            <div class="absolute inset-0 bg-linear-to-t from-black/40 to-transparent opacity-60 group-hover:opacity-80 transition-opacity duration-500"></div>
                        </div>
                    @endif
