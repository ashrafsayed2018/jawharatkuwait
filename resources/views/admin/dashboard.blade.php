...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    ...
    <!-- Tags -->
    <x-admin.stat-card title="الوسوم" :count="$tagCount" :views="$tagViews" color="#eab308" :link="route('admin.tags.index')">
        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <!-- Posts -->
    <x-admin.stat-card title="المقالات" :count="$postCount" :views="$postViews" color="#10b981" :link="route('admin.posts.index')">
        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <!-- Services (Sections) -->
    <x-admin.stat-card title="الأقسام" :count="$serviceCount" :views="$serviceViews" color="#3b82f6" :link="route('admin.services.index')">
        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
